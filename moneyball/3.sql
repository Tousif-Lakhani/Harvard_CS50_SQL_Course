...
-- WHERE "first_name" is "Ken" AND "last_name" IS "Griffey" AND "birth_year" = 1969;

-- SELECT "year", "HR" FROM "performances"
-- WHERE "player_id" = ( SELECT "id" FROM "players" WHERE "first_name" is "Ken" AND "last_name" IS "Griffey" AND "birth_year" = 1969 )
-- ORDER BY "year" DESC;
